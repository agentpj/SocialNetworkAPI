...
module.exports = {
  ...
  // Remove thought reaction. This method finds the thought based on ID. It then updates the reaction array associated with the app in question by removing it's reactionId from the reaction array.
